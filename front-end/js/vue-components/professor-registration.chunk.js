...
var DepartmentComponent = _vue2.default.component('department', {
    ...
    methods: {
        registerDepartment: function registerDepartment() {
            ...
            this.$validator.validateAll({
                ...
                console.log('valid');
                _this.sendDepartmentData();
            }).catch(function (error) {
                _this.$parent.showAlertWithCustomMessage("Invalid data");
            });
        },
        sendDepartmentData: function sendDepartmentData() {
            var _this2 = this;
            ...
            _axios2.default.post('/professor/department', data, []).then(function (response) {
                _this2.$parent.departments.push(response.data);
                $('#departmentModal').modal('hide');
                _this2.departmentName = "";
                _this2.departmentBelongsToUniversity = "";
                _this2.departmentBelongsToFaculty = "";
                _this2.departmentInfo = "";
            }).catch(function (error) {
                _this2.$parent.showAlertWithCustomMessage("Invalid data");
            });
        }
    }
});
...
var FacultyComponent = _vue2.default.component('faculty', {
    ...
    methods: {
        registerFaculty: function registerFaculty() {
            var _this = this;
            ...
            this.$validator.validateAll({
                ...
                console.log('valid');
                _this.sendFacultyData();
            }).catch(function (error) {
                _this.$parent.showAlertWithCustomMessage("Invalid data");
            });
        },
        sendFacultyData: function sendFacultyData() {
            var _this2 = this;
            ...
            _axios2.default.post('/professor/faculty', data, []).then(function (response) {
                _this2.$parent.faculties.push(response.data);
                _this2.facultyBelongsToUniversity = "";
                _this2.facultyName = "";
                _this2.facultyBranch = "";
                _this2.facultyInfo = "";
...
exports.default = FacultyComponent;
...
var UniversityComponent = _vue2.default.component('university', {
    ...
    methods: {
        registerUniversity: function registerUniversity() {
            var _this = this;
            ...
            this.$validator.validateAll({
                ...
                _this.sendUniversityData();
            }).catch(function (error) {
                _this.$parent.showAlertWithCustomMessage("Invalid data");
            });
        },
        sendUniversityData: function sendUniversityData() {
            var _this2 = this;
            ...
            _axios2.default.post('/professor/university', data, []).then(function (response) {
                _this2.$parent.universities.push(response.data);
                _this2.university_name = "";
                _this2.university_address = "";
                _this2.university_country = "";
                _this2.university_city = "";
                _this2.university_site = "";
                _this2.university_email = "";
                $("#universityModal").modal('hide');
            }).catch(function (error) {
                // implment Error message showing
                _this2.$parent.showAlertWithCustomMessage("InstitutionComponents not succefully created");
            });
        }
    }
});
...
var _university = __webpack_require__(133);

var _university2 = _interopRequireDefault(_university);

var _faculty = __webpack_require__(132);

var _faculty2 = _interopRequireDefault(_faculty);

var _department = __webpack_require__(131);
...
var Registartion = new _vue2.default({
    el: '#root',
    components: {
        UniversityComponent: _university2.default,
        FacultyComponent: _faculty2.default,
        DepartmentComponent: _department2.default,
    ...
    methods: {
        checkEquality: function checkEquality(pass, val) {
            if (pass == val) {
        ...
        uploadImage: function uploadImage(event) {
            ...
            _axios2.default.post('/professor/image', data, config).then(function (response) {
        ...
        toFirstTab: function toFirstTab(event) {
        ...
        getUniversities: function getUniversities() {
            ...
            _axios2.default.get('/professor/university/all').then(function (response) {
                _this2.universities = response.data;
                _this2.universities.forEach(function (university) {
                    university.faculty.forEach(function (faculty) {
                        _this2.faculties.push(faculty);
                        faculty.department.forEach(function (department) {
                            _this2.departments.push(department);
                        });
                    });
                });
            }).catch(function (error) {
        ...
        storeUserInformation: function storeUserInformation() {
            var _this3 = this;
            ...
            _axios2.default.post('/user/create', data, []).then(function (response) {
                _this3.userId = response.data.id;
                _this3.userEmail = response.data.email;
            }).catch(function (error) {
        ...
        nextTab: function nextTab(event) {
            ...
            this.$validator.validateAll({
                ...
                _this4.activeTab = 1;
                var mail = _this4.email;
                _this4.emailExists(mail);
                return false;
            }).catch(function (error) {
                console.log(error);
                _this4.showTop = true;
                ...
                _this4.errorMsg = "Please fill out with correct data ";
                return false;
            });
            return false;
        },
        emailExists: function emailExists(email) {
            ...
            _axios2.default.post('/user/email', data, []).then(function (response) {}).catch(function (error) {
                _this5.activeTab = 0;
                _this5.showTop = true;
                _this5.setAlertToFalse();
                _this5.errorMsg = " User with e-mail " + email + " allready exists";
            });
        },
        ...
        getUserVendorData: function getUserVendorData(email) {
            var _this8 = this;

            _axios2.default.get('/session/' + email).then(function (response) {
                _this8.imageUrl = response.data.picture;
                _this8.image = response.data.picture;
                _this8.name = response.data.first_name;
                _this8.surname = response.data.last_name;
                _this8.email = response.data.email;
            }).catch(function (error) {
                _this8.showAlertWithCustomMessage(error.message);
            });
        }
    },
    ...
    watch: {
        ...
        rePassword: function rePassword(val, oldVal) {
