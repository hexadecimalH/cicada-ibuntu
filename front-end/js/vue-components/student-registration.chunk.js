...
var Registartion = new _vue2.default({
    ...
    methods: {
        ...
        uploadImage: function uploadImage(event) {
            ...
            _axios2.default.post('/image', data, config).then(function (response) {
                _this.image = response.data;
                _this.imageUrl = response.data;
            }).catch(function (error) {
                _this.showAlertWithCustomMessage("Image failed to Upload please refresh the page and try again");
            });
        },
        getUniversities: function getUniversities() {
            ...
            _axios2.default.get('/professor/university/all').then(function (response) {
                ...
                _this2.showAlertWithCustomMessage("Error loading Universities " + error.message);
            });
        },
        nextTab: function nextTab(event) {
            ...
            this.$validator.validateAll({
                ...
                _this3.activeTab = 1;
                var mail = _this3.email;
                _this3.emailExists(mail);
            }).catch(function (error) {
                _this3.showAlertWithCustomMessage("Please fill out with correct data ");
            });
        },
        emailExists: function emailExists(email) {
            ...
            _axios2.default.post('/user/email', data, []).then(function (response) {}).catch(function (error) {
                _this4.activeTab = 0;
                _this4.showAlertWithCustomMessage(" User with e-mail " + email + " allready exists");
            });
        },
        submitData: function submitData(event) {
            ...
            this.$validator.validateAll({
                ...
                _this5.showAlertWithCustomMessage("Validation failed please re-check your data and try submiting");
            });
        },
        sendDataToDb: function sendDataToDb() {
            ...
            _axios2.default.post('/user/create', data, []).then(function (response) {
                ...
                $('#password').val(_this6.password);
                $('#hiddenFormSubmit').submit();
            }).catch(function (error) {
                _this6.showAlertWithCustomMessage(error.message);
            });
        },
        ...
        getUserVendorData: function getUserVendorData(email) {
            ...
            _axios2.default.get('/session/' + email).then(function (response) {
                _this7.imageUrl = response.data.picture;
                _this7.image = response.data.picture;
                _this7.name = response.data.first_name;
                _this7.surname = response.data.last_name;
                _this7.email = response.data.email;
            }).catch(function (error) {
                _this7.showAlertWithCustomMessage(error.message);
            });
        }
    },
