...
var _vueEventCalendar = __webpack_require__(134);

var _vueEventCalendar2 = _interopRequireDefault(_vueEventCalendar);

var _NewAssignmentComonent = __webpack_require__(162);

var _NewAssignmentComonent2 = _interopRequireDefault(_NewAssignmentComonent);

var _NewCourseFiles = __webpack_require__(163);

var _NewCourseFiles2 = _interopRequireDefault(_NewCourseFiles);
 ...
 */
_vue2.default.use(_vueEventCalendar2.default, { locale: 'en' });
_vue2.default.use(_veeValidate2.default);

var Course = new _vue2.default({
    el: '#wrapper',
    components: {
        NewAssignemntComonent: _NewAssignmentComonent2.default,
        NewCourseFilesComonent: _NewCourseFiles2.default,
        tabset: _vueStrap.tabset,
        tabs: _vueStrap.tabs,
        tab: _vueStrap.tab,
    ...
    methods: {
        ...
        deleteStoredFiles: function deleteStoredFiles(id) {
            var _this = this;

            _axios2.default.delete('/dashboard/files/' + id).then(function (response) {
                console.log(response.data);
                _this.removeElementFromArray(_this.courseFiles, id);
            }).catch(function (error) {
                _this.showTop = true;
                _this.setAlertToFalse();
                _this.errorMsg = error.message;
            });
        },
        sendCourseInfo: function sendCourseInfo() {
            var _this2 = this;
            ...
            _axios2.default.post('/dashboard/course/info/' + id, data, []).then(function (response) {
                console.log(response.data);
                _this2.toggleEdit();
            }).catch(function (error) {
                _this2.showTop = true;
                _this2.setAlertToFalse();
                _this2.errorMsg = error.message;
            });
        },

        coursePath: function coursePath(id) {
            return "/dashboard/course/" + id;
        },
        acceptStudentRequest: function acceptStudentRequest(event) {
            var _this3 = this;

            var requestId = this.getIdFromEvent(event);
            _axios2.default.put('/dashboard/request/approve/' + requestId).then(function (response) {
                _this3.requests.forEach(function (request) {
                ...
                _this3.showTop = true;
                _this3.setAlertToFalse();
                _this3.errorMsg = error.message;
            });
        },
        deleteStudentRequest: function deleteStudentRequest(event) {
            var _this4 = this;

            var requestId = this.getIdFromEvent(event);
            _axios2.default.delete('/dashboard/request/' + requestId).then(function (response) {
                _this4.removeElementFromArray(_this4.requests, requestId);
            }).catch(function (error) {
                _this4.showTop = true;
                _this4.setAlertToFalse();
                _this4.errorMsg = error.message;
            });
        },
        getIdFromEvent: function getIdFromEvent(event) {
            return $(event.target).attr('data-id');
        },
        ajustNameToShow: function ajustNameToShow(name) {
            if (name.length < 23) {
                return name;
            } else {
                return name;
        ...
        getProfessorsCourses: function getProfessorsCourses() {
            var _this5 = this;

            var self = this;
            _axios2.default.get('/dashboard/course/professor').then(function (response) {

                _this5.courses = response.data;
                var courseId = _this5.getCourseId();
                _this5.courses.forEach(function (course) {
                ...
                _this5.showTop = true;
                _this5.setAlertToFalse();
                _this5.errorMsg = error.message;
            });
        },
        getRequestsForCourse: function getRequestsForCourse() {
            var _this6 = this;

            this.courseId = this.getCourseId();
            _axios2.default.get('/dashboard/request/' + this.courseId).then(function (response) {
                _this6.requests = response.data;
            }).catch(function (error) {
                _this6.showTop = true;
                _this6.setAlertToFalse();
                _this6.errorMsg = error.message;
            });
        },
        getCourseData: function getCourseData() {
            ...
            _axios2.default.get('/dashboard/course-info/' + id).then(function (response) {
                if (response.data.info != null) {

                    var content = response.data.info;
                    _this7.content = response.data.info;
                    tinyMCE.activeEditor.setContent(content);
                    $('#content').html(content);
                }
            }).catch(function (error) {
                _this7.showTop = true;
                _this7.setAlertToFalse();
        ...
        deleteAssignment: function deleteAssignment(event) {
            ...
            _axios2.default.delete("/dashboard/assignment/" + id).then(function (response) {
                console.log(response);
                _this8.removeElementFromArray(_this8.assignments, id);
            }).catch(function (error) {
                _this8.showTop = true;
                _this8.setAlertToFalse();
                _this8.errorMsg = error.message;
            });
        },
        editAssignment: function editAssignment(event) {
            var _this9 = this;

            var id = this.getIdFromEvent(event);
            this.currentAssignment = id;
            this.assignments.forEach(function (assigment) {
                if (assigment.id == id) {
                    _this9.currentAssignment = assigment;
                }
            });
        },
        removeElementFromArray: function removeElementFromArray(array, elementId) {
        ...
        getSelfObject: function getSelfObject() {
            return this;
        }
    },
...
var NewAssignmentComonent = _vue2.default.component('new-assignment', {
    ...
    computed: {},
    methods: {
        openUpload: function openUpload(event) {
            event.preventDefault();
            var id = $(event.target).attr('data-id');
            $("#" + id).click();
        },
        storeFilesInVar: function storeFilesInVar(event) {
        ...
        createAssignemt: function createAssignemt(event) {
            var _this = this;
            ...
            _axios2.default.post('/dashboard/assignment/' + this.root.getCourseId(), data).then(function (response) {
                console.log(response.data);
                _this.root.assignments.push(response.data);
            }).catch(function (error) {
                _this.showTop = true;
                _this.setAlertToFalse();
                _this.errorMsg = error.message;
        ...
        updateAssignment: function updateAssignment(event) {
            var _this2 = this;
            ...
            _axios2.default.put('/dashboard/assignment', dataUpdate).then(function (response) {
                console.log(response.data);
...
exports.default = NewAssignmentComonent;
...
var NewCourseFilesComonent = _vue2.default.component('new-files', {
    ...
    methods: {
        ...
        storeFiles: function storeFiles(event) {
            var _this = this;
            ...
            _axios2.default.post('/dashboard/upload/' + this.root.getCourseId(), data, config).then(function (response) {
                console.log(response.data);
                _this.root.courseFiles.push(response.data);
                _this.fileName = "";
                $('#upload').val('');
                _this.uploadedFilesNames = '';
            }).catch(function (error) {
                _this.showTop = true;
                _this.setAlertToFalse();
                _this.errorMsg = error.message;
...
exports.default = NewCourseFilesComonent;
