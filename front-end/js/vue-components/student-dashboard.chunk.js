...
var DashboardStudent = new _vue2.default({
    el: '#wrapper',
    components: {
    ...
    methods: {
        ...
        getCoursesForDepartment: function getCoursesForDepartment() {
            var _this = this;

            _axios2.default.get('/dashboard/course/student').then(function (response) {
                _this.courses = response.data;
                _this.departmentName = response.data[0].department.name;
        ...
        requestSubmit: function requestSubmit(event) {
            var _this2 = this;

            var courseId = $(event.target).attr('data-id');
            _axios2.default.post('/dashboard/request/' + courseId).then(function (response) {
                console.log(response.data);
                _this2.courses.forEach(function (course) {
        ...
        deleteRequest: function deleteRequest(event) {
            var _this3 = this;
        ...
        generateUrl: function generateUrl(course) {
...
exports.default = DashboardStudent;
