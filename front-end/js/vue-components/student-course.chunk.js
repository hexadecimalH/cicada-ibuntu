...
var CourseStudent = new _vue2.default({
    el: '#wrapper',
    components: {
    ...
    methods: (_methods = {
        ...
        getCoursesForDepartment: function getCoursesForDepartment() {
            ...
            _axios2.default.get('/dashboard/course/student').then(function (response) {
                ...
                var courseId = _this2.getCourseId();
                _this2.courses.forEach(function (course) {
                    if (course.id == courseId) {
                        _this2.courseFiles = course.course_files;
                        _this2.assignments = course.assignments;
                    }
                });
                _this2.departmentName = response.data[0].department.name;
            }).catch(function (error) {
                _this2.showTop = true;
    ...
    }, _defineProperty(_methods, 'getCourseId', function getCourseId() {
        var url = window.location.href;
        var array = url.split('/');
        var id = array[array.length - 1];
        return id.replace(/\D/g, '');
    }), _defineProperty(_methods, 'beautifyDate', function beautifyDate(date) {
